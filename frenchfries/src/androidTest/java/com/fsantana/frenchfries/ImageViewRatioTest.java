...
import com.fsantana.frenchfries.Activitys.ImageViewTestActivity;
 ...
 *
 * Todos os testes são na orientação Portraid
...
public class ImageViewRatioTest {
    ...
    @Rule
    public ActivityTestRule<ImageViewTestActivity> mImageViewTestActivity =
    ...
    @Before
    public void setUp () {
        mImageViewTest = mImageViewTestActivity.getActivity();
    }
